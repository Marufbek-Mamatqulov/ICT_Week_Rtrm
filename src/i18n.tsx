...
const dictionaries: Record<Lang, Record<string, string>> = {
  ...
  'footer.link.contact': 'Contact Us',
    'hero.title': 'The Future of Innovation & Technology',
    'hero.tagline': 'Join leaders, creators and visionaries shaping tomorrow. Explore breakthroughs, network and accelerate impact.',
    'hero.cta.program': 'Program',
